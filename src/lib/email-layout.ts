        ...
        <tr><td style="padding:32px 36px 36px;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            <tr><td style="border-top:1px solid ${RULE};padding-top:20px;font-family:${FONT};font-size:13px;color:${MUTED};">
              <a href="${WHATSAPP_URL}" style="display:inline-block;color:${INK};text-decoration:none;font-weight:600;border:1px solid ${RULE};border-radius:999px;padding:9px 16px;">💬&nbsp; Chat us on WhatsApp</a>
