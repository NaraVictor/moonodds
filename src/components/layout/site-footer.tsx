      ...
      <div className="mx-auto w-full max-w-[110rem] px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-16 border-t border-separator pt-8">
          ...
          <p className="mt-8 text-xs leading-relaxed text-muted">
            18+. MoonOdds publishes AI sports predictions. It provides analysis,
            not guarantees, and does not take bets or hold funds. Predictions are generated by a model and nothing here is a
